...
class media_vimeo_testcase extends advanced_testcase {
    ...
    /**
     * Test embedding without media filter (for example for displaying URL resorce) and test that player plugin is parsing the URL with the code.
     */
    ...
    /**
     * Test that mediaplugin filter replaces a link to the supported file with media tag and test that player plugin is parsing the URL with the code.
     *
     * filter_mediaplugin is enabled by default.
     */
    ...
    /**
     * Test that mediaplugin filter adds player code on top of <video> tags and test that player plugin is parse the URL with the code.
     *
     * filter_mediaplugin is enabled by default.
     */
