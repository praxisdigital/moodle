...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configselect('mod_assign/gradetype', // I asked on telegram and they said to prefix plugintype.
                                                    $name,
                                                    $description,
                                                    GRADE_TYPE_VALUE, [
    ...
    $setting = new admin_setting_configselect('mod_assign/gradescale', // I asked on telegram and they said to prefix plugintype.
                                                    $name,
                                                    $description,
                                                    0, $choices);
    $settings->add($setting);
    $settings->hide_if('mod_assign/gradescale', 'mod_assign/gradetype', 'neq', GRADE_TYPE_SCALE);
