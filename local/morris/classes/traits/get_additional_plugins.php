...
trait get_additional_plugins{

	/**
	 * @return external_function_parameters
	 */
	public static function get_additional_plugins_parameters(){
	 ...
	 */
	public static function get_additional_plugins(){
		self::validate_parameters(self::get_additional_plugins_parameters(), []);

		$plugin_manager = core_plugin_manager::instance();
		$plugins = new \local_morris\plugins($plugin_manager);
		return $plugins->additional();
	}

	/**
	 * @return external_multiple_structure
	 */
	public static function get_additional_plugins_returns(){
