...
$string['regradeprogressbarcount'] = 'Regrade minimum for progressbar';
$string['regradeprogressbarcount_help'] = 'This setting determines the minimum number of grades to be regraded for before a progressbar is shown.';
$string['regradeprogressbarcount_validateerror'] = 'This setting must be an integer between 1 and 10000.';
